  ...
  return (
    <nav className='flex items-center justify-between p-2 px-8 max-h-[80px]   shadow-lg'>
       ...
       <div className='relative top-4'>
        ...
        <h1 className='navHeading text-sm'>Poke<span className='text-primary'>book</span></h1>
       </div>
       <div className='hidden md:flex'> <div className='flex justify-between items-center p-2 px-4 gap-1  rounded-full border border-gray-300 shadow-lg '>
       <MagnifyingGlassIcon  className="h-4 w-4 text-gray-500" />
      <input className='outline-none bg-transparent text-sm px-4 min-w-[300px]' name='searchBar' placeholder='Enter pokemon name' />
